...
- Tokens are used to allow the user to access private or protected routes
- [ ] What steps can you take in your web apps to keep your data secure?
- Allow unauthenticated users minimal access and not allow them to edit the api data until after being authenticated. 
- [ ] Describe how web servers work.
- A web server processes incoming requests using several protocols. (put, get, delete, post calls)
